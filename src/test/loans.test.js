...
describe('loansHandler', () => {
  ...
  it('should return array of loans for Admin', (done) => {
    supertest(server)
      .get('/api/v1/loans')
      .set('authorization', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJkYXZpZDEzQGdtYWlsLmNvbSIsImlzQWRtaW4iOnRydWUsImZpcnN0TmFtZSI6InJvd2xhbmQiLCJsYXN0TmFtZSI6InVzZXIiLCJzdGF0dXMiOiJwZW5kaW5nIiwiaWF0IjoxNTU4NjQ0ODY0LCJleHAiOjE1NTg4MTc2NjR9.erFfJzlVGvfu1tCEnrau0WbenpulNZdQa61ZYueLef0')
      .end((err, res) => {
